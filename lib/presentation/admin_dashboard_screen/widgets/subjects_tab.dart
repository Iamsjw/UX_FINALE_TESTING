...
class _SubjectsTabState extends State<SubjectsTab> {
  ...
  Future<void> _loadSubjects() async {
    ...
    try {
      ...
      debugPrint('[UI] SubjectsTab._loadSubjects() got ${subjects.length} subjects');
      if (mounted) {
        setState(() {
          _subjects = subjects;
          _isLoading = false;
            ...
            onPressed: () async {
              if (formKey.currentState!.validate()) {
                ...
                if (result != null && mounted) {
                  Navigator.pop(ctx, true); // ignore: use_build_context_synchronously
                } else if (mounted) {
          ...
          child: _subjects.isEmpty
              ? Center(
                  child: EmptyStateWidget(
                    ...
                    description: 'Add subjects to assign them to teachers and classes.',
                  ),
                )
              : ListView.separated(
                  padding: const EdgeInsets.all(16),
